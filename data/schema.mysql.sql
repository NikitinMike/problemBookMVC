...
(
   ...
   0, '2020-01-01 10:50','user9'),
(
   '00ya@ya.ru',
   'Встав на цыпочки и вытянув руки вверх, Митенька может дотянуться до нижней полки кухонного шкафа, на которой стоят соль, перец и горчица. Расстояние от нижней полки этого шкафа до верхней, на которой стоит клубничное варенье, 48 см. Митенька вырастает в месяц на 2 см. Сколько лет понадобится Митеньке, чтобы добраться до клубничного варенья, не вставая на стул?', 
   0, '2020-01-01 10:50','user0')
;
